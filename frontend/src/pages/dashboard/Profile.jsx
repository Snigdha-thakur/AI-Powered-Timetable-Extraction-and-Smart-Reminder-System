...
export default function Profile() {
  ...
  const [form, setForm]       = useState({ full_name: '', registration_number: '', phone: '', department: '', degree: '', sem: '' })
  ...
  const save = async (e) => {
    ...
    try {
      const d = await api.post('/auth/profile/setup', form)
          ...
          <div className={styles.profileHeader}>
            ...
            <div>
              ...
              {profile.registration_number && (
                <div className={styles.profileReg}>{profile.registration_number}</div>
              )}
              {profile.department && (
                <div className={styles.profileMeta}>{profile.department} · {profile.degree} · {profile.sem}</div>
              )}
            </div>
          </div>
        )}
